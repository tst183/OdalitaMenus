package nl.odalitadevelopments.menus.nms.v26_2;
...
import nl.odalitadevelopments.menus.nms.v26_2.packet.ClientboundSetContentsPacket_v26_2;
import nl.odalitadevelopments.menus.nms.v26_2.packet.ClientboundSetSlotPacket_v26_2;
...
public final class OdalitaMenusNMS_v26_2 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v26_2.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerCommonPacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v26_2.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v26_2(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v26_2(clientboundContainerSetContentPacket);
    }
