...
public final class ClientboundSetContentsPacket_v26_2 implements ClientboundSetContentsPacket {

    private final ClientboundContainerSetContentPacket packet;
    private final List<ItemStack> items;
    private final ItemStack carriedItem;

    public ClientboundSetContentsPacket_v26_2(ClientboundContainerSetContentPacket packet) {
        this.packet = packet;
