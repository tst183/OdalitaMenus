package nl.odalitadevelopments.menus.nms.v26_1;
...
import nl.odalitadevelopments.menus.nms.v26_1.packet.ClientboundSetContentsPacket_v26_1;
import nl.odalitadevelopments.menus.nms.v26_1.packet.ClientboundSetSlotPacket_v26_1;
...
public final class OdalitaMenusNMS_v26_1 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v26_1.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerCommonPacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v26_1.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v26_1(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v26_1(clientboundContainerSetContentPacket);
    }
