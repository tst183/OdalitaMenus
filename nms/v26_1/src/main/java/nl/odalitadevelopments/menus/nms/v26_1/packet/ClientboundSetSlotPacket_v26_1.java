package nl.odalitadevelopments.menus.nms.v26_1.packet;
...
import nl.odalitadevelopments.menus.nms.v26_1.ObfuscatedNames_v26_1;
import org.bukkit.craftbukkit.inventory.CraftItemStack;
import org.bukkit.inventory.ItemStack;
import org.jetbrains.annotations.NotNull;

public final class ClientboundSetSlotPacket_v26_1 implements ClientboundSetSlotPacket {

    private static final Reflections.FieldAccessor<net.minecraft.world.item.ItemStack> ITEM_FIELD;

    static {
        ITEM_FIELD = Reflections.getField(ClientboundContainerSetSlotPacket.class, net.minecraft.world.item.ItemStack.class, ObfuscatedNames_v26_1.SET_SLOT_PACKET_ITEM);
    }

    private final ClientboundContainerSetSlotPacket packet;
    private final ItemStack item;

    public ClientboundSetSlotPacket_v26_1(ClientboundContainerSetSlotPacket packet) {
        this.packet = packet;
